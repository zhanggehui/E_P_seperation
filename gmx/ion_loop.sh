...
for ((i=0; i<${n_ions}; i++)); do
    ...
    if [ -d ./$ion ]; then
        ...
        if [ $1 == 'em' ]; then
            ...
            $run_gmx 2 /home/liufeng_pkuhpc/lustre3/zgh/GO_MD/md_scripts/gmx nvt-equ.sh nvtequ
        elif [ $1 == 'nvtpull' ]; then
            $run_gmx 2 /home/liufeng_pkuhpc/lustre3/zgh/GO_MD/md_scripts/gmx nvt-pull.sh nvtpull
